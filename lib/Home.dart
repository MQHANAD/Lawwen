...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<PaletteModel> _allPalettes = []; // replaces the old global list
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: _buildPaletteGrid(displayedPalettes),
                  ),
                ),
              ],
            );
  ...
  Widget _buildPaletteGrid(List<PaletteModel> palettes) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
